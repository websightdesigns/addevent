...
$start_date = "2019-02-21 10:00:00"; // 10am
$end_date = "2019-02-21 16:00:00"; // 4pm
			...
			<div class="col-md-12">
				<div class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="addEventDropDown">
						...
						<li><a href="https://outlook.live.com/owa/?path=/calendar/view/month&rru=addevent&amp;startdt=<?= rawurlencode($fstart_date) ?>&amp;enddt=<?= rawurlencode($fend_date) ?>&amp;subject=<?= rawurlencode($event_name) ?>&amp;location=<?= rawurlencode($event_location) ?>&amp;body=<?= str_replace("%5Cn", "%0A", rawurlencode($event_details)) ?>" target="_blank">Outlook Online</a></li>
